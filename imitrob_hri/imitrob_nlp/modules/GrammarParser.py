...
from imitrob_hri.imitrob_nlp.structures.tagging.MorphCategory import POS
from imitrob_hri.imitrob_nlp.structures.tagging.ParsedText import ParsedText, ParseTreeNode
